document.addEventListener("DOMContentLoaded", function () {
    ...
    // Handler for renewing books
    function handleRenewBook(loanId) {
      // Implement renew functionality if needed
      console.log("Renew book with ID:", loanId);
      showMessage("Renew functionality not implemented yet", "warning");
    }
    ...
    function displayNotifications(notifications) {
      ...
      // Add event listeners to mark as read buttons - WITHOUT confirmation dialog
      document.querySelectorAll(".mark-read-btn").forEach((btn) => {
        btn.addEventListener("click", function() {
          ...
          // Call handler directly without confirmation
          markNotificationAsRead(notificationId);
        });
      });
  
      // Add event listeners to renew buttons - WITHOUT confirmation dialog
    ...
    async function setupUserProfile() {
          ...
          if (profileForm) {
            ...
            profileForm.addEventListener("submit", async function (e) {
              ...
              if (passwordField && passwordField.value) {
                ...
                if (confirmPasswordField && !validateConfirmPassword(passwordField, confirmPasswordField)) {
                  isValid = false;
                }
              }
              ...
              try {
                ...
                if (profileFeedback) {
                  ...
                  profileFeedback.textContent = result.message || "Profile updated successfully!";
      ...
      function validateEmail(emailField) {
        ...
        toggleValidationFeedback(emailField, isValid, "Please enter a valid email address");
        return isValid;
      }
      ...
      function validatePassword(passwordField) {
        ...
        toggleValidationFeedback(passwordField, isValid, "Password must be at least 6 characters long");
        return isValid;
      }
